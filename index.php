...
<!-- Mirrored from htmldemo.net/centgix/index-software-innovation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jan 2024 10:28:26 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>centgix - Technology IT Solutions </title>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="info-item">
                                                    ...
                                                    <div class="info-content">
                                                        ...
                                                        <div class="info-sub-title"> centegix@gmail.com</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                        ...
                                        <nav class="navigation-menu navigation-menu--text_white">
                                            ...
                                            <ul>
                                                    ...
                                                    <ul class="submenu">
                                                        <li class="has-children">
                                                            ...
                                                            <ul class="submenu">
                                                                ...
                                                                <li><a href="about-us-02.php"><span>About us </span></a></li>
                                                                <li class="has-children">
                                                ...
                                                <li class="has-children has-children--multilevel-submenu">
                                                    ...
                                                    <ul class="submenu">
                                                        <li><a href="it-services.html"><span>Website Development</span></a></li>
                                                        <li><a href="MobileAppDevelopment.php"><span>Mobile Application Development</span></a></li>
                                                        <li><a href="industries.html"><span>Custom Software Development</span></a></li>
                                                        <li><a href="business-solution.html"><span>Cloud Services</span></a></li>
                                                        <li><a href="it-services-details.html"><span>Student Internship Programs</span></a></li>
                                                        <li><a href="it-services-details.html"><span>USB Digital Signature Encryption Keys</span></a></li>
                                                        <li><a href="it-services-details.html"><span>Digital Marketing</span></a></li>
                                        ...
                                        <a href="#" class="projects-wrap style-04 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <div class="image">
                                                        <img class="img-fluid" src="assets/images/icons/soft-s1-01-120x120.webp" alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        ...
                                        <a href="#" class="projects-wrap style-04 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <div class="image">
                                                        <img class="img-fluid" src="assets/images/icons/soft-s1-02-120x120.webp" alt="">
                                                    </div>
                                                </div>
                                                <div class="content text-center">
                                                    <h5 class="heading">Outsourcing development</h5>
                                                    <div class="text">Lorem dolor sit amet, consectetur elit. Suspeo sitea. spe ndisse suscipit sagittis leo sitea rem ipsum dolor sit
                                                    </div>
                                                    <div class="box-projects-arrow">
                                                        <span class="button-text">Discover now</span>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        ...
                                        <a href="#" class="projects-wrap style-04 wow move-up">
                                            <div class="projects-image-box">
                                                <div class="projects-image">
                                                    <div class="image">
                                                        <img class="img-fluid" src="assets/images/icons/soft-s1-03-120x120.webp" alt="">
                                                    </div>
                                                </div>
                                                <div class="content text-center">
                                                    <h5 class="heading">Information Technology Support</h5>
                                                    <div class="text">Lorem dolor sit amet, consectetur elit. Suspeo sitea. spe ndisse suscipit sagittis leo sitea rem ipsum dolor sit
                                                    </div>
                                                    <div class="box-projects-arrow">
                                                        <span class="button-text">Discover now</span>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                        ...
                                        <div class="ht-box-images style-10">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/soft-s3-01.webp" alt="">
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading">IT Counsultancy</h5>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                        ...
                                        <div class="ht-box-images style-10">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/soft-s3-02.webp" alt="">
                                                </div>
                                                <div class="content">
                                                    <h5 class="heading">Custom Software Development</h5>
                                                    <div class="box-images-arrow">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                        ...
                                        <div class="ht-box-images style-10">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/soft-s3-03.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                        ...
                                        <div class="ht-box-images style-10">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/soft-s3-04.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                        ...
                                        <div class="ht-box-images style-10">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/soft-s3-05.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                        ...
                                        <div class="ht-box-images style-10">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/soft-s3-06.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                        ...
                                        <div class="ht-box-images style-10">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/soft-s3-07.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 wow move-up">
                                        ...
                                        <div class="ht-box-images style-10">
                                            <div class="image-box-wrap">
                                                <div class="box-image">
                                                    <img class="img-fulid" src="assets/images/icons/soft-s3-08.webp" alt="">
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <a href="#" class="projects-wrap style-01 wow move-up">
                                            <div class="projects-image-box">
                                                ...
                                                <div class="content">
                                                    <h6 class="heading">centgix-Smart Vision</h6>
                                                    <div class="post-categories">Cyber Security</div>
                                                    <div class="text">At centgix, we have a holistic and integrated approach towards core modernization to experience technological evolution.
                                                    </div>
                                                    <div class="box-projects-arrow">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="section-title section-space--pt_60">
                                ...
                                <h3 class="text-white"><span class="text-color-secondary">Centegix</span> – Top Software
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center text-md-start">
                            <span class="copyright-text">&copy; 2023 centgix. <a href="https://hasthemes.com/">All Rights Reserved.</a></span>
                        </div>
    ...
    <div class="demo-option-container">
        ...
        <div class="demo-option-wrapper">
            <div class="demo-panel-header">
                <div class="title">
                    <h6 class="heading mt-30">IT Solutions centgix - Technology, IT Solutions & Services Html5 Template</h6>
                </div>
...
<!-- Mirrored from htmldemo.net/centgix/index-software-innovation.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jan 2024 10:28:29 GMT -->
</html>