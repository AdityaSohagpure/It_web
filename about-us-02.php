...
<head>
    ...
    <title>About Centegix IT Solutions Pvt. Ltd.</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Technology IT Solutions HTML Template">
    <!-- Favicon -->
    <link rel="icon" href="assets/images/icons/info-button.png">
                    ...
                    <div class="col-lg-12">
                        <div class="header default-menu-style position-relative">
                            ...
                            <div class="header__logo">
                                <a href="index-2.html">
                                    <img src="assets/images/logo/centgix_logo.png" aria-label="Mitech Logo" width="160" height="48" class="img-fluid" alt="">
                                </a>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="section-title-wrap text-center section-space--mb_60">
                                ...
                                <h3 class="heading">About <span class="text-color-primary"> Centegix</span> IT Solutions Pvt. Ltd.
                                    </h3>
                            </div>

                            <div class="software-innovation-about-company-area ">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-lg-6">
                                            <div class="image-inner-video-section">
                                                <img class="img-fluid border-radus-5" src="assets/images/banners/soft-s2-01.webp" alt="">
                                            </div> -->
                                        </div>
                                        <div class="col-lg-12 ms-auto mt-30">
                                            <div class="machine-learning-about-content">
                                                <div class="section-title mb-20">
                                                    ...
                                                    <div class="section-title-wrap text-left section-space--mb_30">
                                                        ...
                                                        <h3 class="heading">
                                                            Innovative Solutions for Business<span class="text-color-primary">
                                                                  Success</span>
                                                        </h3>
                                                    </div>
                                                    <!-- section-title-wrap Start -->
                
                                                    <p class="dec-text mt-20">Centegix IT Solutions Pvt. Ltd. is a dynamic technology company committed to delivering innovative solutions that empower businesses to thrive in the digital age. With a team of experienced professionals and a passion for excellence, we are dedicated to exceeding our clients' expectations and driving tangible results.</p>
                                                    
                                                    <div class="section-title-wrap text-left section-space--mb_30">
                                                        
                                                        <h3 class="heading">
                                                            Pioneering Technology for Business<span class="text-color-primary">
                                                                  Success</span>
                                                        </h3>
                                                    </div>

                                                    <p class="dec-text mt-20">Since our inception, we have been at the forefront of technological advancements, helping businesses leverage the latest tools and strategies to achieve their goals. Our customer-centric approach, coupled with our technical expertise, sets us apart as a trusted partner for all your IT needs.
                                                    </p>


                                                    <h3 class="heading">
                                                        Trusted Partnerships, Innovative<span class="text-color-primary">
                                                            Solutions</span>
                                                    </h3>
                                                </div>

                                                <p class="dec-text mt-20">At Centegix IT Solutions Pvt. Ltd., we believe in forging long-lasting relationships built on trust, transparency, and integrity. We are driven by a relentless pursuit of excellence and a commitment to delivering solutions that make a real difference.
                    ...
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                <li>Nagpur, Maharashtra, India
                                </li>
                                <li><a href="mailto:info@centegix.in" 
                                    class="hover-style-link">info@centegix.in                                </a></li>
                                <li><a href="tel:123344556" class="hover-style-link text-black font-weight--bold">Contact : 7020011419
                                </a></li>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center text-md-start">
                            <span class="copyright-text">&copy; 2024 Centegix. <a href="https://hasthemes.com/">All Rights Reserved.</a></span>
                        </div>
...
<!-- Mirrored from htmldemo.net/mitech/about-us-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jan 2024 10:28:53 GMT -->
</html>